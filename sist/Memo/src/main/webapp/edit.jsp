...
<%
    ...
    //2. DB 작업 > 수정할 메모를 가져오기(select.. where)
    //3. 화면 출력
...
<form method="POST" action="${pageContext.request.contextPath}/editok.jsp">
    <table class="vertical">
        ...
        <tr>
            <th>메모</th>
            <td>
                <textarea name="memo" class="full" required><%= memo %></textarea>
            </td>
        </tr>
    </table>
    <div>
