...
<h2>View</h2>
	...
	<table class="vertical">
		<tr>
			<th>언어</th>
			<td><i class="${dto.category.icon}" style="color : ${dto.category.color}"></i> ${dto.category.name}</td>
		</tr>
		<tr>
			<th>제목</th>
			<td>${dto.subject}</td>
		...
		<tr>
			<th>코드</th>
			<td><pre><code id="code" class="language-${dto.category.name}"><c:out value="${dto.code}"></c:out></code></pre></td>
		</tr>
		<tr>
			<th>날짜</th>
			<td>${dto.regdate}</td>
